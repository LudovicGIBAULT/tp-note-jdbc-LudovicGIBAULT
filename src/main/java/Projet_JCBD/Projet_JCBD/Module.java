...
public class Module implements Serializable
{
	...
	public String toString() {
		return "Module [code=" + code + ", libelle=" + libelle + ", discipline=" + discipline + ", hCoursPrev="
				+ hCoursPrev + ", hCoursRea=" + hCoursRea + ", hTpPrev=" + hTpPrev + ", hTpRea=" + hTpRea
				+ ", coefTest=" + coefTest + ", coefCC=" + coefCC + ", responsable=" + responsable + ", pere=" + pere
				+ "]";
	}
	...
	public Module getPere() {return pere;}

	public void setPere(Module pere) {this.pere = pere;}
	
	public Prof getResponsable() {return responsable;}

	public void setResponsable(Prof responsable) {this.responsable = responsable;}
	...
	public void setCoefTest(int cpefTest) {this.coefTest = cpefTest;}
